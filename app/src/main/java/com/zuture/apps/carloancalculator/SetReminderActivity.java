...
public class SetReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentReminderUri == null) {
            ...
            Cursor cursor = getContentResolver().query(mCurrentReminderUri, null, null, null, null);
    ...
    public void setTime(View v){
      ...
      TimePickerDialog tpd = TimePickerDialog.newInstance(
        ...
        tpd.setAccentColor(getResources().getColor(R.color.colorDialog));
    ...
    public void setDate(View v){
     Calendar now = Calendar.getInstance();
       ...
       DatePickerDialog dpd = DatePickerDialog.newInstance(
        ...
        dpd.setAccentColor(getResources().getColor(R.color.colorDialog));
    ...
    public void setRepeatNo(View v){
        AlertDialog.Builder alert = new AlertDialog.Builder(this,R.style.ThemeDialog);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(SetReminderActivity.this);
                    return true;
                }
    ...
    private void showDeleteConfirmationDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(SetReminderActivity.this,R.style.DeleteDialog);
        builder.setTitle("Delete reminder");
        builder.setMessage(getResources().getString(R.string.delete_dialog_msg));
